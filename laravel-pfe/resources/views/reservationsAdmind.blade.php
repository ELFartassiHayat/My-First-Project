...
<div class="admin-panel clearfix">
  <div class="slidebar">
    ...
    <ul>
      ...
      <li><a href="#media">Users</a></li>
      <li><a href="#pages">employe</a></li>
      <li><a href="#links">stocke</a></li>
...
<button type="button" class="btn btn-danger">pas en cors</button>
    @endif</td>
        ...
        <td>{{ $reservation->nombre_preson }} </td>
         <td><a class="btn btn-danger" href="/adminReserVationdelete/{{$reservation->id}}" role="button">delete</a>

         <td><a class="btn btn-primary" href="/adminReserVationAccept/{{$reservation->id}}" role="button">accept</a>
</td>
