...
<div class="admin-panel clearfix">
  <div class="slidebar">
    ...
    <ul>
      ...
      <li><a href="/adminReservation">reservations</a></li>
      <li><a href="/images">images</a></li>
      <li><a href="/employe">employe</a></li>
      <li><a href="/adminchambre">chambre</a></li>
      <li><a href="#comments">timing</a></li>
          <li><a href="#settings">settings</a></li>
    </ul>
  </div>
  <div class="main">
    <ul class="topbar clearfix" style="width: 78vw;">
        ...
        <h2 class="header"><span class="icon"></span>Dashboard</h2>
          <div class="monitor">
            ...
            <div class="clearfix">
              <ul class="content">
                <li>content</li>
                <li class="posts"><span class="count">179</span><a href="/reservations">reservations</a></li>
                <li class="pages"><span class="count">13</span><a href="/images">images</a></li>
                <li class="categories"><span class="count">21</span><a href="/employe">employe</a></li>
                <li class="categories"><span class="count">21</span><a href="/chambre">employe</a></li>
