...
<div class="admin-panel clearfix">
  ...
  <tbody>
    ...
    <th scope="col">une suite est un intervale </th>
    <th scope="col">250dh </th>

    <th scope="col"> <button type="button" class="btn btn-danger">delete</button>
</th>
<tbody>
    ...
    <th scope="col"> <button type="button" class="btn btn-success">add</button>
</th>
  </tbody>
</table>
   </div>
